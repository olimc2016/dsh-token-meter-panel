      ...
      import_react.default.createElement("div", { key: "split", style: S.card }, [
        ...
        import_react.default.createElement(
          ...
          [
            ...
            import_react.default.createElement(
              "div",
              { key: "k", style: { textAlign: "right", fontSize: 11, color: C.label3, fontVariantNumeric: "tabular-nums" } },
              fmtM(tokens)
            ),
            // ③ 金额
            import_react.default.createElement(
              "div",
              { key: "v", style: { textAlign: "right", fontWeight: 650, color: C.label, fontVariantNumeric: "tabular-nums" } },
              money(cost)
            ),
            ...
            import_react.default.createElement("div", {
              ...
              return [
                ...
                import_react.default.createElement("span", {
                  key: "p",
                  style: wide ? { position: "absolute", top: -3, left: `calc(${p.toFixed(1)}% - 36px)`, fontSize: 11, fontWeight: 700, color: "#04070d", fontVariantNumeric: "tabular-nums" } : { position: "absolute", top: -3, left: `calc(${p.toFixed(1)}% + 6px)`, fontSize: 11, fontWeight: 600, color: C.label2, whiteSpace: "nowrap", fontVariantNumeric: "tabular-nums" }
                }, `${p.toFixed(0)}%`)
              ];
            })())
          ]))
