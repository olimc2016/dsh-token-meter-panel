          ...
          import_react.default.createElement("div", { key: "f", style: { fontSize: 11.5, color: C.label3, lineHeight: 1.7 } }, [
            (() => {
              ...
              return import_react.default.createElement("div", {
                ...
                import_react.default.createElement("span", { key: "why" }, `${t("officialLabel")}\uFF1A${off?.reason === "disabled" ? t("officialOff") : off?.reason === "no-credential" ? t("notConnected") : off?.error ?? t("balanceFailed")} `),
                import_react.default.createElement("span", {
                  key: "go",
                  onClick: () => {
                    try {
