        ...
        import_react.default.createElement("div", {
          ...
          import_react.default.createElement("div", {
            ...
            const row = (label, tk, prices, cny) => import_react.default.createElement("div", {
              ...
              import_react.default.createElement("span", { key: "h" }, `${t("hitInput")} ${fmt(tk?.hit ?? 0)} \xD7 \xA5${prices.hit}`),
              import_react.default.createElement("span", { key: "p1" }, "+"),
              import_react.default.createElement("span", { key: "m2" }, `${t("missInput")} ${fmt(tk?.miss ?? 0)} \xD7 \xA5${prices.miss}`),
              import_react.default.createElement("span", { key: "p2" }, "+"),
              import_react.default.createElement("span", { key: "o" }, `${t("output")} ${fmt(tk?.out ?? 0)} \xD7 \xA5${prices.out}`)
            ]);
            if (!tier || (tier.peak?.calls ?? 0) === 0 && (tier.offPeak?.calls ?? 0) === 0) {
              return [
                import_react.default.createElement("div", { key: "one", style: { display: "flex", gap: 6, flexWrap: "wrap" } }, [
                  ...
                  import_react.default.createElement("span", { key: "eq" }, "="),
                  import_react.default.createElement("span", { key: "h" }, `${t("hitInput")} ${fmt(D.hit)} \xD7 \xA5${unit.hit}`),
                  import_react.default.createElement("span", { key: "p1" }, "+"),
                  import_react.default.createElement("span", { key: "p2" }, `${t("missInput")} ${fmt(D.miss)} \xD7 \xA5${unit.miss}`),
                  import_react.default.createElement("span", { key: "p3" }, "+"),
                  import_react.default.createElement("span", { key: "o" }, `${t("output")} ${fmt(D.out)} \xD7 \xA5${unit.out}`),
