  ...
  return import_react.default.createElement("div", {
    ...
    import_react.default.createElement("div", {
      ...
      import_react.default.createElement("div", {
        ...
        import_react.default.createElement(Stat, { key: "1", t, label: t("hitInput"), color: C.hit, value: fmt(D.hit) }),
        ...
        import_react.default.createElement(Stat, { key: "3", t, label: t("missInput"), color: C.miss, value: fmt(D.miss) }),
        import_react.default.createElement(Stat, { key: "4", t, label: t("output"), color: C.out, value: fmt(D.out) }),
        ...
        import_react.default.createElement("div", {
          ...
          " = ",
          `${t("hitInput")} ${fmt(D.hit)} \xD7 \xA5${unit.hit}`,
          " + ",
          `${t("missInput")} ${fmt(D.miss)} \xD7 \xA5${unit.miss}`,
          " + ",
          `${t("output")} ${fmt(D.out)} \xD7 \xA5${unit.out}`
        ])
      ]),
      /* 第三栏：峰谷时段与峰谷价 */
      import_react.default.createElement("div", {
