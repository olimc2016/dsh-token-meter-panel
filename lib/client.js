    ...
    import_react.default.createElement("div", {
      ...
      import_react.default.createElement("div", {
        ...
        import_react.default.createElement("div", {
          ...
          }, `${delta >= 0 ? "\u2191" : "\u2193"} ${Math.abs(delta).toFixed(0)}% ${t("vsPrev")}${prevKey ? ` \xB7 ${prevKey.slice(5)}` : ""}`) : null
        ]),
        ...
        import_react.default.createElement("div", {
          ...
          import_react.default.createElement("span", { key: "l", style: { fontSize: 12, color: C.label2 } }, t("savedToday")),
          import_react.default.createElement("span", {
            key: "v",
          ...
          import_react.default.createElement(
            "span",
            { key: "c", style: { fontSize: 11, color: C.label3 } },
    ...
    import_react.default.createElement("div", { key: "trend", style: card }, [
      import_react.default.createElement("div", {
        ...
        dataDays < 3 ? import_react.default.createElement("span", {
          key: "hint",
          onClick: range === 7 ? () => setRange(30) : void 0,
          style: {
            fontSize: 10.5,
            color: C.label3,
            border: `1px solid ${C.border}`,
            borderRadius: 999,
            padding: "1px 8px",
            cursor: range === 7 ? "pointer" : "default"
          }
        }, t("fewDays")) : null,
